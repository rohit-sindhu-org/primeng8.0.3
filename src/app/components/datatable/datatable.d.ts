import { ElementRef, AfterContentInit, AfterViewInit, AfterViewChecked, OnInit, OnDestroy, DoCheck, ViewContainerRef, EventEmitter, Renderer, IterableDiffers, QueryList, TemplateRef, ChangeDetectorRef, NgZone } from '@angular/core';
...
export declare class DataTable implements AfterViewChecked, AfterViewInit, AfterContentInit, OnInit, DoCheck, OnDestroy, BlockableUI {
    ...
    constructor(el: ElementRef, domHandler: DomHandler, differs: IterableDiffers, renderer: Renderer, changeDetector: ChangeDetectorRef, objectUtils: ObjectUtils, ngZone: NgZone);
    ngOnInit(): void;
    ...
    scrollableBodytableAlignment(): void;
    setScrollableBodyTableWidth(classname: string, width: number): void;
    ...
    onFilterKeyup(event: any, value: any, field: any, matchMode: any): void;
    ...
    durationvalue(v: any): boolean;
    generateExcelFile(filter?: any): any;
    s2ab(s: any): ArrayBuffer;
    exportExcel(filter?: any): void;
    visibleColumns(): Column[];
    initialPerUnfrozenWidth: number;
    calculateUnforzenWidth(): void;
    isWidthinPercentage(width: any): boolean;
    calculatePerWidth(width: any, forzen: boolean): any;
    ngOnDestroy(): void;
}
